...
export class MainView extends React.Component {
  ...
  // this function updates the user property in state to that particular user (which is passed in as an argument to this function) and sets the selectedMovie property to null.
        ...
        <Container fluid>
          <Row className='main-view justify-content-md-center'>
            ...
            <Route
              ...
              path='/'
              render={() => {
                // if user is not found return us to the log in
                if (!user)
                  return (
                    <Col>
